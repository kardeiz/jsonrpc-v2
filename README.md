...
Also see the `easy-errors` feature flag (not enabled by default). Enabling this flag will implement [`ErrorLike`](https://docs.rs/jsonrpc-v2/0.5.1/jsonrpc_v2/trait.ErrorLike.html)
...
Otherwise, custom errors should implement [`ErrorLike`](https://docs.rs/jsonrpc-v2/0.5.1/jsonrpc_v2/trait.ErrorLike.html) to map errors to the JSON-RPC 2.0 `Error` response.
